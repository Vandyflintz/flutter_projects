...
class MainReceipts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: MainMainReceipts(),
    );
  }
}

class MainMainReceipts extends StatefulWidget {
  MainMainReceipts({Key? key}) : super(key: key);

  @override
  State createState() => _MainReceiptsState();
}

class _MainReceiptsState extends State<MainMainReceipts>

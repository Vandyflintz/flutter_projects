...
void main() => runApp(InactiveWorkers());

class InactiveWorkers extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainInactiveWorkers(),
    );
  }
}

class MainInactiveWorkers extends StatefulWidget with PreferredSizeWidget {
  @override
  State createState() => new InactiveWorkersState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class InactiveWorkersState extends State<MainInactiveWorkers>

...
void main() => runApp(ActiveChannelWorkers());

class ActiveChannelWorkers extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainActiveChannelWorkers(),
    );
  }
}

class MainActiveChannelWorkers extends StatefulWidget with PreferredSizeWidget {
  @override
  State createState() => new ActiveChannelWorkersState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class ActiveChannelWorkersState extends State<MainActiveChannelWorkers>

...
import 'package:emkapp/mainactivechanneladmins.dart';
import 'package:emkapp/mainactiveworkers.dart';
import 'package:emkapp/maininactivechanneladmins.dart';
import 'package:emkapp/shippedcars.dart';
import 'package:emkapp/unshippedcars.dart';
...
import 'channelcars_in_stock.dart';
import 'channelcars_sold.dart';
import 'inactiveadmins.dart';
import 'keep_page_alive.dart';
import 'maininactiveworkers.dart';
import 'shipped_sold.dart';

void main() => runApp(AllChannelCars());

class AllChannelCars extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAllChannelCars(),
    );
  }
}

class MainAllChannelCars extends StatefulWidget {
  @override
  State createState() => new AllChannelCarsState();

  void onNotify(String s) {
    AllChannelCarsState().onNotify(s);
  }
}

class AllChannelCarsState extends State<MainAllChannelCars>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(child: ChannelCarsInStock()),
        KeepAlivePage(child: ChannelCarsSold()),
      ],
    );
  }

...
Future main() async {
  ...
  runApp(AddAdminWorker());
}
//void main() => runApp(AddAdminWorker());

class AddAdminWorker extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAddAdminWorker(),
    );
  }
}

class MainAddAdminWorker extends StatefulWidget {
  @override
  State createState() => new AddAdminWorkerState();
}
...
class AddAdminWorkerState extends State<MainAddAdminWorker>
  ...
  void initState() {
    ...
    super.initState();
    pcolor = Colors.black;
    demo.channel = 'Admin20210508024527';
    _populatedropdowns();
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      _delrole(
                          'Admin20210508024527', roledata[index]['roleid']);
                    },
                  )
                ],
              ),

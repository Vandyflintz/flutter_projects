...
void main() => runApp(CarFinances());

class CarFinances extends StatelessWidget {
  @override
...
class MainCarFinances extends StatefulWidget {
  MainCarFinances({Key? key, required this.opt}) : super(key: key);
  final String opt;
  @override
  State createState() => new CarFinancesState();
}

class CarFinancesState extends State<MainCarFinances>
  ...
  late AnimationController _fabcon;
  @override
  void initState() {
  ...
  _updatecardata() async {
    var url = "http://www.emkapp.com/emkapp/channelcars.php";
    var bdata = {
      "updaterequest": "true",
      'lotnum': _lotnumcontroller.text,
      'carpartsamt': _partscostcontroller.text,
      'shippingamt': _shippingcostcontroller.text,
      'purchaseamt': _purchasingcostcontroller.text,
      'towingamt': _towingcostcontroller.text
    };
    ...
    try {
      ...
      if (jsonDecode(response.data).toString().contains("successfully")) {
        setState(() {
          ...
          _towingcostcontroller.clear();
          _shippingcostcontroller.clear();
          _purchasingcostcontroller.clear();
          _lotnumcontroller.clear();
          _detailsformvisible = false;
          _showCars(wchannel);
        });
      } else {
        _showsnackbar(
            "Error processing request : " + response.data.toString(), "Close");
        setState(() {
...
return ntcMatch[1];
  ...
  String _carname = "", _mainimage = "", _lotnumber = "";
  var listname;
  ...
  _showCars(String chan) async {
    ...
    var bdata = {"request": "extras", "channel": chan};
    FormData fdata = FormData.fromMap(bdata);
  ...
  TextEditingController _lotnumcontroller = new TextEditingController();
  TextEditingController _partscostcontroller = new TextEditingController();
  TextEditingController _purchasingcostcontroller = new TextEditingController();
  TextEditingController _shippingcostcontroller = new TextEditingController();
  TextEditingController _towingcostcontroller = new TextEditingController();
  GlobalKey<FormState> _extrasformkey = GlobalKey<FormState>();

  Widget _buildFormDetailsWidget() {
    var datawidget;
    if (_carname.isEmpty) {
      ...
      setState(() {
        _lotnumcontroller.text = _lotnumber;
      });
      datawidget = GestureDetector(
        onTap: () {
          //_showfullpicture(item.username, item.userimg);
        },
        child: Column(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                        'Key in details of expenses here',
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(
                                    color: Colors.grey.shade800, width: 11),
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: new RaisedButton(
                                    ...
                                    onPressed: () {
                                      final form = _extrasformkey.currentState;
                                      if (form!.validate()) {
                                        form.save();
                    ...
                    child: Padding(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Visibility(
                              visible: _detailsformvisible,
                              child: _buildFormDetailsWidget()),
                          Visibility(

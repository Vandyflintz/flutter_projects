...
void main() => runApp(AllWorkAdmins());

class AllWorkAdmins extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAllWorkAdmins(),
    );
  }
}

class MainAllWorkAdmins extends StatefulWidget {
  @override
  State createState() => new AllWorkAdminsState();
}

class AllWorkAdminsState extends State<MainAllWorkAdmins>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(child: MainActiveAdmins()),
        KeepAlivePage(child: MainInactiveAdmins()),
      ],
    );
  }

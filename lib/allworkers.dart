...
class MainAllWorkers extends StatefulWidget {
  @override
  State createState() => new AllWorkersState();
}

class AllWorkersState extends State<MainAllWorkers>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(child: MainActiveWorkers()),
        KeepAlivePage(child: MainInactiveWorkers()),
      ],
    );
  }

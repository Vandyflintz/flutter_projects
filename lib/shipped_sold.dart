...
void main() => runApp(ShippedSold());

class ShippedSold extends StatelessWidget {
  @override
...
class MainShippedSold extends StatefulWidget {
  MainShippedSold({Key? key, required this.opt}) : super(key: key);
  final String opt;
  @override
  State createState() => new ShippedSoldState();
}

class ShippedSoldState extends State<MainShippedSold>

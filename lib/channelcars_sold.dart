...
void main() => runApp(ChannelCarsSold());

class ChannelCarsSold extends StatelessWidget {
  @override
...
class MainChannelCarsSold extends StatefulWidget {
  MainChannelCarsSold({Key? key, required this.opt}) : super(key: key);
  final String opt;
  @override
  State createState() => new ChannelCarsSoldState();
}

class ChannelCarsSoldState extends State<MainChannelCarsSold>
...
return ntcMatch[1];
  ...
  _showCars(String chan) async {
    ...
    var bdata = {"request": "sold", "channel": chan};
    FormData fdata = FormData.fromMap(bdata);

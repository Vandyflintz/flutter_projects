...
void main() => runApp(AdminWorkerSales());

class AdminWorkerSales extends StatelessWidget {
  @override
...
class MainAdminWorkerSales extends StatefulWidget {
  final GlobalKey<AdminWorkerSalesState> adminstaticGlobalKey =
      new GlobalKey<AdminWorkerSalesState>();
  final String defaultdate;
  final String defaulttotal;
  MainAdminWorkerSales(
      {Key? key, required this.defaultdate, required this.defaulttotal})
      : super(key: key);
  @override
  AdminWorkerSalesState createState() => new AdminWorkerSalesState();
}

class AdminWorkerSalesState extends State<MainAdminWorkerSales>
...
return ntcMatch[1];
  ...
  _showlogoutdialog(BuildContext context) async {
    ...
    final _configcontent = '{"role":"' +
        ...
        '","username":"' +
        username +
        '","logged_in":"false","AdminWorkerSales":"false","img":"' +
        _imgname +
        '","cookiename":"' +
        cookiename +
        '","last_logged_in_at":"' +
  ...
  _getallsoldcars(String ndefaultdate) async {
    ...
    var bdata = {"sdate": ndefaultdate, "getadminworkersales": "true"};

...
void main() => runApp(AddChannelAdminCar());

class AddChannelAdminCar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAddChannelAdminCar(),
    );
  }
}

class MainAddChannelAdminCar extends StatefulWidget {
  @override
  State createState() => new AddChannelAdminCarState();
}
...
class AddChannelAdminCarState extends State<MainAddChannelAdminCar>
  ...
  void initState() {
    ...
    _shippingcostcontroller = new TextEditingController();
  ...
  _uploadadmincar(String imageencoded, String imagenames) async {
    ...
    var bdata = {
      ...
      'partscost': _partscostcontroller.text.toString(),
      'shippingcost': _shippingcostcontroller.text.toString(),
      'purchasingcost': _purchasingcostcontroller.text.toString(),
      'towingcost': _towingcostcontroller.text.toString(),
    ...
    var url = "http://www.emkapp.com/emkapp/api/addchanneladmincar.php";
    ...
    try {
      ...
      if (jsonDecode(jsonEncode(response.data))
        ...
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext ncontext) => MainChannelAdminDashboard(
                      opt: "2",
                      nrdate: '',
                    )));
      } else {

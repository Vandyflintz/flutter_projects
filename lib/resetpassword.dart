...
class ResetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainResetPassword(userid: '', page: '', image: ''),
    );
  }
}
...
class MainResetPassword extends StatefulWidget {
  ...
  final String image;
  MainResetPassword(
      {Key? key, required this.userid, required this.page, required this.image})
      : super(key: key);
  @override
  State createState() => new ResetPasswordState();
}

class ResetPasswordState extends State<MainResetPassword>
  ...
  String user = '', password = '', message = '', _secqn = '', _secan = '';
  ...
  resetpassword(userid, pw, secqn, secans) async {
    ...
    try {
      ...
      if (jsonDecode(response.data).toString().contains("user not found")) {
        ...
        try {
          ...
          if (widget.page.contains("login")) {
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (context) => LoginPage()));
          }
          if (widget.page.contains("lockscreen")) {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) =>
                        MainLockScreen(userimg: widget.image)));
          }

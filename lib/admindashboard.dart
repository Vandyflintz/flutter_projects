...
import 'package:emkapp/addcaradmin.dart';
import 'package:emkapp/allchanneladmins.dart';
import 'package:emkapp/allworkers.dart';
import 'package:emkapp/debtors.dart';
import 'package:emkapp/invoicesandreceipts.dart';
import 'package:emkapp/messages.dart';
import 'package:emkapp/salescontainer.dart';
import 'package:emkapp/stolencar.dart';
import 'package:emkapp/transfers.dart';
...
import 'addchanneladmin.dart';
import 'addworkeradmin.dart';
import 'allcarscontainer.dart';
import 'login.dart';
...
class MainAdminDashboard extends StatefulWidget {
  MainAdminDashboard({Key? key, required this.opt, required this.nrdate})
      : super(key: key);
  final String opt;
  final String nrdate;
  @override
  State createState() => new AdminDashboardState();
}

class AdminDashboardState extends State<MainAdminDashboard>
  ...
  String _serveresponse = '', _totalmsgs = "";
  ...
  List<MenuItem> createMenuItems() {
    ...
    smenuItems = [
      new MenuItem("Add Worker", "983146", Colors.black,
          () => new MainAddAdminWorker(), ov),
      new MenuItem("Add Channel Admin", "983146", Colors.black,
          () => new MainAddChannelAdmin(), ov),
      new MenuItem(
          "Add Cars", "63001", Colors.black, () => new MainAddAdminCar(), ov),
      new MenuItem(
          "All Workers", "63432", Colors.black, () => new MainAllWorkers(), ov),
      new MenuItem("All Channel Admins", "63432", Colors.black,
          () => new MainAllChannelAdmins(), ov),
      new MenuItem(
          "All Cars", "59449", Colors.black, () => new MainAllCars(), ov),
      new MenuItem(
          "Sales",
          "58780",
          Colors.black,

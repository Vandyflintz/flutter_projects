...
void main() => runApp(AddAdminCar());

class AddAdminCar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAddAdminCar(),
    );
  }
}

class MainAddAdminCar extends StatefulWidget {
  @override
  State createState() => new AddAdminCarState();
}
...
class AddAdminCarState extends State<MainAddAdminCar>
  ...
  late List<DropdownMenuItem<String>> _dropDownMenuShippingStatus;
  List imagelist = [];
  ...
  late TextEditingController _yearcontroller,
      ...
      _shippercontactcontroller,
      _shipperresidentialaddresscontroller,
      _caraddresscontroller,
      _vincontroller;
  ...
  void dispose() {
    ...
    _shippercontactcontroller.dispose();
    _shipperresidentialaddresscontroller.dispose();
    _caraddresscontroller.dispose();
  ...
  void initState() {
    ...
    _shippernamecontroller = new TextEditingController();
    _shipperemailcontroller = new TextEditingController();
    _shippercontactcontroller = new TextEditingController();
    _shipperresidentialaddresscontroller = new TextEditingController();
    _caraddresscontroller = new TextEditingController();
    ...
    _dropDownMenuShippingStatus = getDropDownMenuSippingStatus();
  }
  ...
  getcardata(String cnum) async {
    ...
    try {
      ...
      if (data.statusCode == 200) {
        ...
        setState(() {
          _vinvisibility = false;
          _diagvisibility = false;
          _yearcontroller.text = jsonData["attributes"]["year"].toString();
          _makecontroller.text = jsonData["attributes"]["make"].toString();
          _modelcontroller.text = jsonData["attributes"]["model"].toString();
          _trimcontroller.text = jsonData["attributes"]["trim"].toString();
          _countrycontroller.text =
              jsonData["attributes"]["made_in"].toString();
          _chassisnocontroller.text = jsonData["input"]["vin"].toString();
          _wblcontroller.text =
              jsonData["attributes"]["wheelbase_length"].toString();
          _dimensioncontroller.text = "height : " +
              jsonData["attributes"]["overall_height"].toString() +
              ",  length : " +
              jsonData["attributes"]["overall_length"].toString() +
              ", width : " +
              jsonData["attributes"]["overall_width"].toString();
          _abscontroller.text =
              jsonData["attributes"]["anti_brake_system"].toString();
          _drivetraincontroller.text =
              jsonData["attributes"]["drivetrain"].toString();
          _mileagecontroller.text = "city mileage : " +
              jsonData["attributes"]["city_mileage"].toString() +
              ", highway mileage : " +
              jsonData["attributes"]["highway_mileage"].toString();
          _bodycontroller.text = jsonData["attributes"]["style"].toString();
          _enginecontroller.text = jsonData["attributes"]["engine"].toString();
          _transmissioncontroller.text =
              jsonData["attributes"]["transmission"].toString();
        });

        _showsnackbar("Data successfully received...", "Close");
      }
  ...
  _uploadadmincar(String imageencoded, String imagenames) async {
    String chan = "Admin20210508024527";
    String lotnum = chan.substring(0, 4) +
    ...
    var bdata = {
      ...
      'car_shippingcost': "",
      'car_towingcost': "",
      'channel': 'Admin20210508024527',
      'car_lotnum': lotnum,
      'admininsertrequest': 'true',
      'insertedby': uid,
      'car_year': _yearcontroller.text.toString(),
      'car_make': _makecontroller.text.toString(),
      'car_model': _modelcontroller.text.toString(),
      'shippername': _shippernamecontroller.text.toString(),
      'shippercontact': _shippercontactcontroller.text.toString(),
      'shipperemailaddr': _shipperemailcontroller.text.toString(),
      'shipperresidentialaddr':
          _shipperresidentialaddresscontroller.text.toString(),
      'caraddress': _caraddresscontroller.text.toString(),
    ...
    var url = "http://www.emkapp.com/emkapp/api/addadmincar.php";
    ...
    BaseOptions options = new BaseOptions(
      baseUrl: "http://192.168.43.31/emkapp",
      connectTimeout: 5000,
      receiveTimeout: 3000,
    );
                                      ...
                                      children: <Widget>[
                                        ...
                                        new Padding(
                                            padding:
                                                const EdgeInsets.only(top: 26)),
                                        new TextFormField(
                                          controller: _shippercontactcontroller,
                                          decoration: new InputDecoration(
                                            labelText:
                                                "Shipper's Contact Address",
                                            prefixIcon:
                                        ...
                                        new Padding(
                                            padding:
                                                const EdgeInsets.only(top: 26)),
                                        new TextFormField(
                                          controller: _caraddresscontroller,
                                          decoration: new InputDecoration(
                                            labelText: "Car's Address",
                                            prefixIcon: Icon(Icons.car_rental),
                                          ),
                                          readOnly: false,
                                          keyboardType: TextInputType.text,
                                        ...
                                        new DropdownButtonFormField(
                                            ...
                                            isExpanded: true,
                                            items: _dropDownMenuShippingStatus,

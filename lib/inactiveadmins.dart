...
void main() => runApp(InactiveAdmins());

class InactiveAdmins extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainInactiveAdmins(),
    );
  }
}

class MainInactiveAdmins extends StatefulWidget with PreferredSizeWidget {
  @override
  State createState() => new InactiveAdminsState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class InactiveAdminsState extends State<MainInactiveAdmins>

...
class MainAdminSales extends StatefulWidget {
  final GlobalKey<AdminSalesState> adminstaticGlobalKey =
      new GlobalKey<AdminSalesState>();
  ...
  MainAdminSales(
      ...
      : super(key: key);
  @override
  AdminSalesState createState() => new AdminSalesState();
}

class AdminSalesState extends State<MainAdminSales>
...
return ntcMatch[1];
  ...
  _showlogoutdialog(BuildContext context) async {
    ...
    final _configcontent = '{"role":"' +
        ...
        '","username":"' +
        username +
        '","logged_in":"false","AdminSales":"false","img":"' +
        _imgname +
        '","cookiename":"' +
        cookiename +
        '","last_logged_in_at":"' +
  ...
  _getallsoldcars(String ndefaultdate) async {
    ...
    var bdata = {"sdate": ndefaultdate, "getadminsales": "true"};

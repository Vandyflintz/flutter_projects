...
void main() => runApp(ActiveWorkers());

class ActiveWorkers extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainActiveWorkers(),
    );
  }
}

class MainActiveWorkers extends StatefulWidget with PreferredSizeWidget {
  @override
  State createState() => new ActiveWorkersState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class ActiveWorkersState extends State<MainActiveWorkers>

...
void main() => runApp(InactiveChannelAdmins());

class InactiveChannelAdmins extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainInactiveChannelAdmins(),
    );
  }
}

class MainInactiveChannelAdmins extends StatefulWidget
    with PreferredSizeWidget {
  @override
  State createState() => new InactiveChannelAdminsState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class InactiveChannelAdminsState extends State<MainInactiveChannelAdmins>

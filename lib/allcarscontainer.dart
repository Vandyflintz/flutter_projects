...
class MainAllCars extends StatefulWidget {
  @override
  State createState() => new AllCarsState();

  void onNotify(String s) {
    AllCarsState().onNotify(s);
  }
}

class AllCarsState extends State<MainAllCars> with TickerProviderStateMixin {
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(child: MainUnShippedCars()),
        KeepAlivePage(child: MainShippedCars()),
      ],
    );
  }

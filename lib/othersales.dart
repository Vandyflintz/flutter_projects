...
void main() => runApp(OtherChannelsSales());

class OtherChannelsSales extends StatelessWidget {
  @override
...
class MainOtherChannelsSales extends StatefulWidget {
  final GlobalKey<OtherChannelsSalesState> adminstaticGlobalKey =
      new GlobalKey<OtherChannelsSalesState>();
  final String defaultdate;
  final String defaulttotal;
  MainOtherChannelsSales(
      {Key? key, required this.defaultdate, required this.defaulttotal})
      : super(key: key);
  @override
  OtherChannelsSalesState createState() => new OtherChannelsSalesState();
}

class OtherChannelsSalesState extends State<MainOtherChannelsSales>
  ...
  String imgdir = '';
  bool isfavVisible = true, _detailsvisible = false;
  String carname = "",
      year = "",
      make = "",
      model = "",
...
return ntcMatch[1];
  ...
  List pictureList = [];
  Future<List<SoldCars>>? _future;
  ScrollController _scrollController = ScrollController(keepScrollOffset: true);
  Future<List<SoldCars>> fetchsoldcars() async {
    return carresponse.map((e) => new SoldCars.fromJson(e)).toList();
  }
  ...
  void initState() {
    ...
    _animcon.forward();
    _getallsoldcars(widget.defaultdate);
    super.initState();
  ...
  String _generaltotal = "", _subtotal = "";
  ...
  _showlogoutdialog(BuildContext context) async {
    ...
    final _configcontent = '{"role":"' +
        ...
        '","username":"' +
        username +
        '","logged_in":"false","OtherChannelsSales":"false","img":"' +
        _imgname +
        '","cookiename":"' +
        cookiename +
        '","last_logged_in_at":"' +
  ...
  _getallsoldcars(String ndefaultdate) async {
    print("sdate : " + ndefaultdate);
    var url = "http://www.emkapp.com/emkapp/sales.php";
    var bdata = {"sdate": ndefaultdate, "getotherchannelssales": "true"};
  ...
  refreshPage() {
    _getallsoldcars(widget.defaultdate);
    print("date sent : " + widget.defaultdate);
  }
          ...
          children: <Widget>[
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                width: MediaQuery.of(this.context).size.width,
                height: MediaQuery.of(this.context).size.height - 252,
                child: Container(
                  width: MediaQuery.of(this.context).size.width,
                  height: MediaQuery.of(this.context).size.height,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                Stack(
                  children: [
                    FutureBuilder<List<SoldCars>>(
                        future: _future,
                        builder: (BuildContext context,
                            AsyncSnapshot<List<SoldCars>> snapshot) {
                          ...
                          if (snapshot.hasData) {
                            newsListSliver = ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  SoldCars item = snapshot.data![index];
                            ...
                            Container(
                              ...
                              child: Padding(
                                  padding: const EdgeInsets.only(
                                      left: 17, right: 17, top: 7, bottom: 7),
                                  child: Text(

...
class AddAdminCarState extends State<MainAddAdminCar>
  ...
  _uploadadmincar(String imageencoded, String imagenames) async {
    ...
    var url = 'http://www.emkapp.com/emkapp/connection.php';
    int timeout = 60;
    setState(() {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(response.body);
        if (jsonDecode(jsonEncode(response.body))
            .toString()
          ...
          Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (BuildContext ncontext) =>
                      MainChannelAdminDashboard(opt: "1", nrdate: '')));
        } else {
          setState(() {
            _diagvisibility = false;
        ...
        _showsnackbar("Error connecting to server...", "Close");
        setState(() {
          _diagvisibility = false;
          _diagvisibility = false;
        });
      ...
      Future.delayed(Duration(seconds: 0)).then((value) {
        _showsnackbar("Connection to server timed out!", "Close");
      ...
      Future.delayed(Duration(seconds: 0)).then((value) {
        _showsnackbar("Error connecting to server : $e", "Close");
      });
      setState(() {
        _diagvisibility = false;
      });

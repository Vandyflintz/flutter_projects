...
void main() => runApp(AllChannelAdmins());

class AllChannelAdmins extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: MainAllChannelAdmins(),
    );
  }
}

class MainAllChannelAdmins extends StatefulWidget {
  @override
  State createState() => new AllChannelAdminsState();
}

class AllChannelAdminsState extends State<MainAllChannelAdmins>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(child: MainActiveChannelAdmins()),
        KeepAlivePage(child: MainInactiveChannelAdmins()),
      ],
    );
  }
